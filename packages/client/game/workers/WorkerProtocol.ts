...
import type { PlayerInput } from '../../../shared/interfaces/PlayerInput';
import type { NetworkDiffPayload } from '../../../shared/interfaces/Network';
import type { GameEvent } from '../../../shared/interfaces/GameEvent';
...
/** A local player input for client-side prediction. */
...
export type WorkerToMainMessage = RenderStatesMessage | SimReadyMessage;
